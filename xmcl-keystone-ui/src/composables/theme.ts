...
export function getDefaultTheme(): UIThemeDataV1 {
  return {
    ...
    colors: {
      // Dark theme
      darkAppBarColor: '#0d0618FF',
      darkSideBarColor: '#1a0a2e99',
      darkPrimaryColor: '#a855f7',
      darkBackground: '#0d0618A5',
      darkInfoColor: '#a855f7',
      darkErrorColor: '#f87171',
      darkWarningColor: '#fb923c',
      darkSuccessColor: '#4ade80',
      darkAccentColor: '#c084fc',
      darkCardColor: '#1a0a2ecc',

      // Light theme (gris acogedor, sin dañar los ojos)
      lightAppBarColor: 'rgb(65, 65, 65)',
      lightSideBarColor: 'rgb(59, 59, 59)',
      lightPrimaryColor: '#7c3aed',
      lightBackground: '#616161',
      lightInfoColor: '#7c3aed',
      lightErrorColor: '#ef4444',
      lightWarningColor: '#f97316',
      lightSuccessColor: '#22c55e',
      lightAccentColor: '#a855f7',
      lightCardColor: '#e2e0f080',
    },
